(function() {
  ...
  window.LeadCaptureForm = function(props) {
    ...
    return e('div', { className: 'glass-card-premium p-6 md:p-10 border-yellow-500/40 gold-border-glow max-w-xl mx-auto' },
      submitted ?
        e('div', { className: 'text-center space-y-4 py-8' },
          ...
          e('h3', { className: 'text-2xl font-cinzel text-white' }, 'Consultation Request Confirmed'),
          e('p', { className: 'text-sm text-slate-300 leading-relaxed' },
            'Thank you, ',
            e('strong', { className: 'text-amber-300' }, formData.doctorName || 'Doctor'),
          ...
          e('div', { className: 'p-4 rounded bg-slate-900 border border-slate-800 text-xs text-slate-400' },
        ...
        e('form', { onSubmit: handleSubmit, className: 'space-y-4 text-left' },
          e('div', { className: 'text-center space-y-1 mb-6' },
            e('span', { className: 'badge-pill text-[10px]' }, 'Limited Southwest & National Availability'),
            e('h3', { className: 'text-xl md:text-2xl font-cinzel text-white font-bold' }, 'Claim Free 30-Min Strategy Call'),
          ...
          e('div', { className: 'grid grid-cols-1 sm:grid-cols-2 gap-3' },
            ...
            e('div', null,
              e('label', { className: 'block text-[11px] font-bold text-slate-300 uppercase mb-1' }, 'Practice Name *'),
              e('input', {
                type: 'text',
                required: true,
          ...
          e('div', { className: 'grid grid-cols-1 sm:grid-cols-2 gap-3' },
            e('div', null,
              e('label', { className: 'block text-[11px] font-bold text-slate-300 uppercase mb-1' }, 'Direct Phone Number *'),
              e('input', {
                type: 'tel',
                required: true,
            ...
            e('div', null,
              e('label', { className: 'block text-[11px] font-bold text-slate-300 uppercase mb-1' }, 'Work Email *'),
              e('input', {
                type: 'email',
                required: true,
          ...
          e('div', { className: 'grid grid-cols-1 sm:grid-cols-2 gap-3' },
            e('div', null,
              e('label', { className: 'block text-[11px] font-bold text-slate-300 uppercase mb-1' }, 'City & State *'),
              e('input', {
                type: 'text',
                required: true,
            ...
            e('div', null,
              e('label', { className: 'block text-[11px] font-bold text-slate-300 uppercase mb-1' }, 'Monthly Growth Budget'),
              e('select', {
          ...
          e('div', { className: 'text-center text-[10px] text-slate-400 space-y-1' },
